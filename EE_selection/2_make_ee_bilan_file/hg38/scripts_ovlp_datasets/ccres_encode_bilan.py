...
with open(file) as f:
    ...
    old_row = {"Chrom":"","Start":"","End":"","Exon_ID":"","Score":"","Strand":"", 'Size':"", "Size_merge":"", 'Exact_merge':"", "50pb_merge":"", "Nb_TF":"", "TF_list":"", "tf_count":"","cell_lines":"","cell_lines_count":"", "cCREs_ID":"","cCREs_labels":""}

    for line in lines:
        
        ccre_id = line.strip().split()[18]
        ccre_label = line.strip().split()[19]
...
df.to_csv('exons_ovlpTF_NR_cCREs.bed', sep='\t', index=False, header=False)