...
with open(file) as f:
    ...
    old_row = {"Chrom":"","Start":"","End":"","Exon_ID":"","Score":"","Strand":"", 'Size':"", "Size_merge":"", 'Exact_merge':"", "50pb_merge":"", "Nb_TF":"", "TF_list":"", "tf_count":"","cell_lines":"","cell_lines_count":"", "cCREs_ID":"","cCREs_labels":"","fantom_id":"","fantom_ts":"","fantom_enhancer":""}

    for line in lines:
        
        fantom_enhancer = line.strip().split()[22]
        ...
        if first == True: #if first line of file
            ...
            for key,values in old_row.items():
                if key == "fantom_enhancer":
                    old_row[key] = fantom_enhancer
                else:
        ...
        if chrom == old_row["Chrom"] and start == old_row["Start"] and end == old_row["End"] and gene == old_row["Exon_ID"]:
            old_row["fantom_enhancer"] = old_row["fantom_enhancer"]+","+fantom_enhancer
...
df.to_csv('exons_ovlpTF_NR_cCREs_Fantom5+Enh_Hsap.bed', sep='\t', index=False, header=False)