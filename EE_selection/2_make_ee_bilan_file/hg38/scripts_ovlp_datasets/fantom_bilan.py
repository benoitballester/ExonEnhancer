...
with open(file) as f:
    ...
    old_row = {"Chrom":"","Start":"","End":"","Exon_ID":"","Score":"","Strand":"", 'Size':"", "Size_merge":"", 'Exact_merge':"", "50pb_merge":"", "Nb_TF":"", "TF_list":"", "tf_count":"","cell_lines":"","cell_lines_count":"", "cCREs_ID":"","cCREs_labels":"","fantom_id":"","fantom_ts":""}

    for line in lines:
        
        fantom_id = line.strip().split()[20]
        try:
            fantom_ts = line.strip().split()[26]
        except IndexError:
            fantom_ts = "NA"
        ...
        if chrom == old_row["Chrom"] and start == old_row["Start"] and end == old_row["End"] and gene == old_row["Exon_ID"]:
            ...
            old_row["fantom_ts"] = old_row["fantom_ts"]+","+fantom_ts
...
df.to_csv('exons_ovlpTF_NR_cCREs_Fantom5_Hsap.bed', sep='\t', index=False, header=False)