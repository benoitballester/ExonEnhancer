...
with open(file) as f:
    ...
    old_row = {"Chrom":"","Start":"","End":"","Exon_ID":"","Score":"","Strand":"", 'Size':"", "Size_merge":"", 'Exact_merge':"", "50pb_merge":"", "Nb_TF":"", "TF_list":"", "tf_count":"","cell_lines":"","cell_lines_count":"", "cCREs_ID":"","cCREs_labels":"","fantom_id":"","fantom_ts":"","fantom_enhancer":"", "noncoding_exon":"","cds_start":"","cds_end":"","utr5":"","utr3":""}

    for line in lines:
        # check if it was the cds
        utr3 = line.strip().split()[27]
        ...
        if chrom == old_row["Chrom"] and start == old_row["Start"] and end == old_row["End"] and gene == old_row["Exon_ID"]:
            old_row["utr3"] = old_row["utr3"]+","+utr3
...
df.to_csv('exons_ovlpTF_NR_cCREs_Fantom5+Enh_NonCoding_cdsStartEnd_UTR5_UTR3_Hsap.bed', sep='\t', index=False, header=False)