...
with open(file) as f:
    ...
    old_row = {"Chrom":"","Start":"","End":"","Exon_ID":"","Score":"","Strand":"", 'Size':"", "Size_merge":"", 'Exact_merge':"", "50pb_merge":"","fantom_enhancer":""}

    for line in lines:
        
        fantom_enhancer = line.strip().split()[13]
...
df.to_csv('tmp_fantom', sep='\t', index=False, header=False)