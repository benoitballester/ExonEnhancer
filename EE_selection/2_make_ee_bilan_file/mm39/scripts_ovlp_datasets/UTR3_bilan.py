...
with open(file) as f:
    ...
    old_row = {"Chrom":"","Start":"","End":"","Exon_ID":"","Score":"","Strand":"", 'Size':"", "Size_merge":"", 'Exact_merge':"", "50pb_merge":"","utr3":""}

    for line in lines:
        # check if it was the cds
        utr3 = line.strip().split()[13]
...
df.to_csv('tmp_utr', sep='\t', index=False, header=False)