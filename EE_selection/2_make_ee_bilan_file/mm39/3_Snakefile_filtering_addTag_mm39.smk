#snakemake -c8 -s /home/mouren/Data/repoexonhancer/other_species/overlap/mm39/3_Snakefile_filtering_addTag_mm39.smk
...
rule divide_robust:
    ...
    shell: 
        """
        mkdir /home/mouren/Data/final_files_tokeep/other_species/overlap_bilan/mm39_exons_filtered/robust
        ...
        mv R_* /home/mouren/Data/final_files_tokeep/other_species/overlap_bilan/mm39_exons_filtered/robust
        """

rule addTag:
    input:
        bilan_filtered="mm39_bilan.bed",
        file_rm="robust_bilan_without_nonCoding_firstExon.tsv",
    output:
        robust_catalog="EE_summary_mm39.tsv"
    shell: 
        """
        awk '{{print $4,"R_C"}}' OFS=$'\t' /home/mouren/Data/final_files_tokeep/other_species/overlap_bilan/mm39_exons_filtered/robust/R_C.tsv > exons_tag_id
        awk '{{print $4,"R_NC1"}}' OFS=$'\t' /home/mouren/Data/final_files_tokeep/other_species/overlap_bilan/mm39_exons_filtered/robust/R_NC1.tsv >> exons_tag_id
        awk '{{print $4,"R_UTR"}}' OFS=$'\t' /home/mouren/Data/final_files_tokeep/other_species/overlap_bilan/mm39_exons_filtered/robust/R_UTR.tsv >> exons_tag_id
