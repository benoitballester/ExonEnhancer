...
with open(file) as f:
    ...
    old_row = {"Chrom":"","Start":"","End":"","Exon_ID":"","Score":"","Strand":"", 'Size':"", "Size_merge":"", 'Exact_merge':"", "50pb_merge":"", "noncoding_exon":""}

    for line in lines:
        
        noncoding_exon = line.strip().split()[13]
        noncoding_strand = line.strip().split()[15]
...
df.to_csv('tmp_nc1', sep='\t', index=False, header=False)